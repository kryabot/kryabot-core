...
command_list.append(CreateVote)
command_list.append(FinishVote)
command_list.append(OpenNominations)
command_list.append(CloseNominations)
command_list.append(IgnoreNominate)
command_list.append(VoteHelp)
